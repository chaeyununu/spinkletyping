...
- Fonts and page settings: edit `FONTS` and `defaultSettings` in `app.js`. The prototype loads Pretendard Variable and Fraunces from CDN, with Korean-capable system fallbacks.
